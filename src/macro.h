...
#ifndef HTMLEX_MACRO_H
#define HTMLEX_MACRO_H



typedef struct MACRO
{
  char *name;         /* nombre de la macro */
  char *value;        /* valor de la macro */
  int used;           /* indica si la macro fue utilizada o no */
  struct MACRO *next; /* pr¢xima en la lista */
} MACRO;
